...
TEST(Format, test_format_no_args)
{
...
TEST(Format, test_format_no_args_left_brace_only)
{
	wmcv::FormatString str;
	wmcv::format(str, "{");
...
TEST(Format, test_format_no_args_left_brace_only_with_string_left)
{
	wmcv::FormatString str;
	wmcv::format(str, "A String{");
...
TEST(Format, test_format_no_args_left_brace_only_with_string_right)
{
	wmcv::FormatString str;
	wmcv::format(str, "{A String");
...
TEST(Format, test_format_no_args_right_brace_only)
{
	wmcv::FormatString str;
	wmcv::format(str, "}");
...
TEST(Format, test_format_no_args_right_brace_only_with_string_left)
{
	wmcv::FormatString str;
	wmcv::format(str, "A String}");
...
TEST(Format, test_format_no_args_right_brace_only_with_string_right)
{
	wmcv::FormatString str;
	wmcv::format(str, "}A String");
...
TEST(Format, test_format_extra_args)
{
	wmcv::FormatString str;
...
TEST(Format, test_format_braces_within_braces)
{
	wmcv::FormatString str;
	wmcv::format(str, "{{{{}}}}", "A string");
...
TEST(Format, test_format_uint16)
{
	wmcv::FormatString str;
...
TEST(Format, test_format_uint32)
{
	wmcv::FormatString str;
...
TEST(Format, test_format_uint64)
{
	wmcv::FormatString str;
...
TEST(Format, test_format_nullptr)
{
	wmcv::FormatString str;
